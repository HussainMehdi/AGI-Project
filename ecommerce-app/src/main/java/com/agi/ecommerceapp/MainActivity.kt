...
import com.agi.ecommerceapp.adapters.ProductAdapter
import com.agi.ecommerceapp.data.SampleData
import com.agi.ecommerceapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        adapter = ProductAdapter(SampleData.products) { product ->
    ...
    private fun filterProducts(category: String) {
        val filteredProducts = SampleData.getProductsByCategory(category)
